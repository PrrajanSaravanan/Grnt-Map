      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="bg-gradient-to-br from-emerald-900/20 to-zinc-900 border border-emerald-500/20 rounded-2xl p-6 relative overflow-hidden">
            ...
            <div className="text-5xl font-bold text-white mb-2">38</div>
          ...
          <div className="bg-gradient-to-br from-cyan-900/20 to-zinc-900 border border-cyan-500/20 rounded-2xl p-6 relative overflow-hidden">
            ...
            <div className="text-5xl font-bold text-white mb-2">$420k</div>
          ...
          <div className="bg-gradient-to-br from-purple-900/20 to-zinc-900 border border-purple-500/20 rounded-2xl p-6 relative overflow-hidden">
            ...
            <div className="text-5xl font-bold text-white mb-2">27h</div>
            <div className="text-purple-400 text-sm flex items-center gap-1">
              <span>≈ 3.5</span> working days
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-zinc-900 border border-white/10 rounded-2xl p-6">
            ...
            <div className="space-y-6">
              {[
                { label: "Climate Query", time: "2h ago", val: "38 grants" },
                { label: "STEM Education", time: "2d ago", val: "12 grants" },
                { label: "Community Garden", time: "1w ago", val: "8 grants" },
                { label: "Tech Upgrade", time: "2w ago", val: "15 grants" },
              ].map((item, i) => (
                <div key={i} className="flex items-center gap-4">
                  <div className="text-xs text-zinc-500 w-12 text-right">{item.time}</div>
                  ...
                  <div className="text-sm text-white w-24 text-right font-mono">{item.val}</div>
                </div>
              ))}
            </div>
          </div>
